      ...
      <div className="border-b bg-card transition-colors">
        <div className="container mx-auto px-6 lg:px-8 py-4 lg:py-6">
          <PageHeader
            ...
            subtitle="Sistema de Gestão de Núcleos e Equipamentos de Prevenção contra Incêndios"
            actions={
              canEdit && (
                <Button 
                  size="sm" 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          ...
          <div className="bg-card rounded-lg border p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-medium text-muted-foreground">Equipamentos Monitorados</span>
            </div>
