-- Drop the old function and create new one with correct schema
DROP FUNCTION IF EXISTS update_property(UUID,TEXT,TEXT,DECIMAL,DECIMAL,DECIMAL,DECIMAL,TEXT,INTEGER,TEXT,TEXT,TEXT);

-- Create the correct update function for appraisal.properties
