...
BEGIN
  ...
  executado AS (
    ...
    WHERE r.obra_id = p_obra_id AND r.orcamento_item_id IS NOT NULL
...
-- Also create a batch version for the obras list page
...
BEGIN
  ...
  executado AS (
    ...
    FROM rdo_activities r
    WHERE r.obra_id = ANY(p_obra_ids) AND r.orcamento_item_id IS NOT NULL
